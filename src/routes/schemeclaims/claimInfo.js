    ...
    <div style={modalStyle} className={classes.paper}>
      ...
      <Container>
        ...
        <Row>
          <Col md={6}>
            <Form.Group controlId="formBasicEmail" className="mt-5">
              <Form.Label>
                Aadhar card(front & back)/ Voter ID/ PAN card/ Driving License*
              </Form.Label>
      ...
      <Container className="btncontainer">
        <Row>
          ...
          <Col md={6}>
            <button type="button" className="resubmit-btn">
              RESUBMIT
            </button>
          </Col>
        </Row>
  ...
  return (
    <div className="App">
      <Container fluid className="schemecontainer">
        <Row>
          <Col md={8}>{/* <h4>Scheme Claims</h4> */}</Col>
          <Col md={2}>
          ...
          <Col md={2}>
            <button className="resubmit-btn" onClick={handleOpen}>
              RESUBMIT
            </button>
      ...
      <Container fluid className="schemecontainer">
        <Row>
          <Col md={8}>
            <Card>
              {props?.location?.state?.rows && (
                <Card.Body>
                  <Card.Title>Claim Info</Card.Title>
                  <hr id="hrline" />
                  <h4>
                    <b>{props.location.state.rows.name}</b>
                  </h4>
                  <br />
                  <Card.Text>
                    <Container>
                      <Row>
                        <Col md={3}>
                          ...
                          <p className="subline">
                            {props.location.state.rows.customer_name__c}
                          </p>
                        </Col>
                        <Col md={3}>
                          <p className="heading">Customer Mobile</p>
                          <p className="subline">
                            {props.location.state.rows.customer_phone__c}
                          </p>
                        </Col>
                        <Col md={6}>
                          <p className="heading">Scheme Applied</p>
                          <p className="subline">
                            {props.location.state.rows.scheme_applicable_name}
                          </p>
                        </Col>
                      </Row>
                      <br />
                      <Row>
                        <Col md={3}>
                          ...
                          <p className="subline">
                            ₹ {props.location.state.rows.he_share__c}
                          </p>
                        </Col>
                        <Col md={3}>
                          ...
                          <p className="subline">
                            ...
                            {
                              props.location.state.rows
                                .expected_claim_amount_by_dealer__c
                            }
                          </p>
                        </Col>
                        <Col md={3}>
                          ...
                          <p className="subline">
                            {props.location.state.rows.online_order_no__c}
                          </p>
                        </Col>
                        <Col md={3}>
                          ...
                          <p className="subline">
                            {
                              props.location.state.rows
                                .ref_no_for_reference_schemes_only__c
                            }
                          </p>
                        </Col>
                      </Row>
                      ...
                      <Row>
                        <Col md={3}>
                          <p className="heading">Claim Submission Date</p>
                          <p className="subline">
                            {
                              props.location.state.rows
                                .scheme_claim_submission_date__c
                            }
                          </p>
                        </Col>
                        <Col md={3}>
                          ...
                          <p className="subline">
                            {props.location.state.rows.chassis_no__c}
                          </p>
                        </Col>
                      </Row>
                      <br />
